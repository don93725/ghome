			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-10">
							<div class="panel panel-default opcityDiv" id='showBorder' ondrop="javascript: drop_image(event);" >
							  ...
							  <div class="panel-body">
							   <textarea class="form-control scrollable" id='bd_msg_ctx' style="resize: none;background-color:transparent;" rows="8" placeholder="李宗霖，在想些什麼呢？"></textarea>
							  </div>
							  ...
							  <div class="row">
							  		<div class="col-xs-12 col-sm-8">
							  			<div class="panel-heading" >
								  <button class="btn btn-default" id='uploadTrigger'><span class="glyphicon glyphicon-picture"> 新增照片</span></button>
								  <input type="file" style="display:none;"  id="uploadPhoto" multiple>
								  <button  class="btn btn-default" id='uploadFilmTrigger'><span class="glyphicon glyphicon-facetime-video"> 新增影片</span>
								  </button>
											...
											<div class="dropdown">
												 <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" value="0">
												  ...
												  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
												    <li><a href="#" onclick="chooseCmmtPrvt.call(this,'0');">朋友&nbsp</a></li>
												    <li><a href="#" onclick="chooseCmmtPrvt.call(this,'1');">公開&nbsp</a></li>
												    <li><a href="#" onclick="chooseCmmtPrvt.call(this,'2');">本人&nbsp</a></li>
												  </ul>											
											</div>
				    	...
				    	<div class="row">
					  	...
					  	<img  src="http://www.imageshop.com.tw/pic/shop/home/img1-01.jpg" class="img-circle cmt_mem_pic">
					  			...
					  			<div class="col-xs-12 col-sm-2 boardEdit">
								  			...
								  			<button class="btn btn-danger" onclick="deleteBoard.call('號碼');">
                        ...
                        <!--/carousel-inner-->
							...
							<div class="panel-body updatTime">
								<div class="col-xs-12 col-sm-4 col-sm-offset-8">
									 <fmt:setLocale value="en_US" />
						<fmt:formatDate value="${message_board.bd_upd_time}" pattern="最後更新於 yyyy-MM-dd HH:mm" /> 
								</div>								
							 ...
							 <ul id='b1_commt1' class="list-group" style="display: none;">
								  ...
								  <li class="list-group-item">Morbi leo risus</li>
								  <li class="list-group-item">Porta ac consectetur ac</li>
								  <li  class="list-group-item" ><a href="#" onclick="return false;">顯示更多</a></li>
