...
/**
 * Servlet implementation class GHomePage
 */
@WebServlet("/homepage/GHomePage")
public class GHomePage extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/front_end/GHomePage.jsp");
	}
